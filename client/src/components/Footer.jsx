    ...
    return (
        <footer className="flex justify-center items-center flex-col">
            <div className="card">
                ...
                <Link to='https://www.linkedin.com/in/santinoramosconti/' target="blank" className="socialContainer containerThree">
